...
from lib.helper.helper import logo, agent, W
...
def start():
	parse=argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter,usage="XSSScan -u <target> [options]",add_help=False)
